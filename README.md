...
#### A. Digitalización de Trámites Universitarios (UMSA)
* **a) Modelado del Proceso:** Diagramación del flujo lógico, entradas, validaciones y salidas para la modernización de los trámites seleccionados.
* **b) BPM:** Sistema interactivo con formularios dinámicos y persistencia de datos local basada en estructuras dinámicas de archivos JSON (sin servidores de bases de datos tradicionales).

#### B. Desarrollo 3D y Realidad Virtual
* **a) Animación Sincronizada en Unity:** Escena coreográfica exportada para la web.
* **b) Construcción de un Avatar Digital:** Modelo tridimensional realista generado mediante técnicas de fotogrametría a partir de capturas fotográficas reales de un integrante del grupo.

---

### 2. Actividades Individuales (Procesamiento de Imágenes a Nivel de Píxel)
